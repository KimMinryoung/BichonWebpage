...
const ko = {
    ...
    commuLingoViews: {
        ...
        worldMap: {
            title: '세계 지도',
            description: '인물과 역사 사건에 등장하는 국가·지역의 위치를 살펴보세요. 국기를 누르면 시민권, 민족·국가적 배경, 관련 사건을 함께 볼 수 있습니다.',
            mapLabel: '국가와 지역 지도',
            legend: '지도 범례',
            modern: '현대 국가',
            historical: '역사 국가',
            ...
            boundaryNote: '국경은 현재 세계를 기준으로 표시합니다. 작은 국가와 섬은 국기 마커로 위치를 확인할 수 있습니다.',
            ...
            background: '민족·국가',
            events: '사건',
            citizenshipPeople: '시민권 인물',
            backgroundPeople: '민족·국가적 배경 인물',
...
const en = {
    ...
    commuLingoViews: {
        ...
        worldMap: {
            title: 'World Map',
            description: 'Locate the countries and regions represented by people and historical events. Select a flag to see citizenship, national background, and directly related events together.',
            ...
            boundaryNote: 'Borders follow the present-day world. Flag markers locate small countries and islands that are difficult to see at this scale.',
