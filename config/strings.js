...
const ko = {
    ...
    commuLingoViews: {
        ...
        eventPanel: {
            ...
            timelineMap: '연표와 지도',
            timeline: '연표',
            controlPhase: '시기별 세력 범위',
            controlPlay: '재생',
            controlPause: '정지',
            controlSources: '지도 출처',
            byCountry: '나라별 보기',
            allCountries: '전체',
            relatedPeople: '관련 인물',
            inDepth: '상세',
        ...
        worldMap: {
            title: '세계 지도',
            description: '등록된 모든 국가·지역의 위치를 살펴보세요. 인물과 사건이 아직 없는 국가는 목록에만 표시됩니다. 국기를 누르면 소속 국가(주요 활동 당시 속했던 나라), 출신 배경(출신 나라·민족적 뿌리), 관련 사건을 함께 볼 수 있습니다.',
            mapLabel: '국가와 지역 지도',
            legend: '지도 범례',
            modern: '현대 국가',
            historical: '역사 국가',
            ...
            zoomIn: '지도 확대',
            zoomOut: '지도 축소',
            resetMap: '기본 축척으로 돌아가기',
            boundaryNote: '국경은 현재 세계를 기준으로 표시합니다.',
            historicalNote: '역사 국가·지역의 영역은 현재 후계 국가 또는 행정구역을 합친 근사 표시이며, 당시의 정확한 국경선이 아닙니다.',
            searchPlaceholder: '국가·지역 이름으로 검색…',
            searchLabel: '세계 지도 국가 검색',
            clearSearch: '검색 지우기',
            oneFound: '개 국가·지역',
            manyFound: '개 국가·지역',
            noneFound: '일치하는 국가·지역이 없습니다.',
            citizenship: '소속 국가',
            background: '출신 배경',
            events: '사건',
            citizenshipPeople: '이 나라에 속했던 인물',
            backgroundPeople: '이 나라를 출신 배경으로 둔 인물',
            relatedEvents: '직접 연루된 역사 사건',
            sectionNav: '국가 페이지 영역',
            viewAll: '전체 인물 보기',
        ...
        people: {
            ...
            peopleCategoriesAndSoviet: '인물 분류와 기관별 지도부 타임라인',
            peopleCategoriesAndSoviet2: '인물 분류와 기관별 지도부',
            theSovietPolitburo: '소련 정치국',
            membership19171991By: '1917–1991 구성원, 시기별·기수별',
            officePage: '기관 페이지 →',
            peopleOfTheSoviet: '소련 내 인물들',
            peopleOfChina: '중국 혁명과 인민공화국의 인물들',
            peopleOfFrance: '프랑스 혁명과 나폴레옹 시대의 인물들',
            peopleBeyondTheSoviet: '그 밖의 세계 인물들',
            viewAsAList: '목록으로 보기 →',
            text: '명',
        },
        peopleList: {
...
const en = {
    ...
    commuLingoViews: {
        ...
        eventPanel: {
            ...
            timeline: 'Timeline',
            controlPhase: 'Territorial control by date',
            controlPlay: 'Play',
            controlPause: 'Pause',
            controlSources: 'Map sources',
        ...
        worldMap: {
            title: 'World Map',
            description: 'Explore all registered countries and regions. Countries with no people or events yet appear only in the list. Select a flag to see citizenship, national background, and directly related events together.',
            ...
            zoomIn: 'Zoom in',
            zoomOut: 'Zoom out',
            resetMap: 'Reset map scale',
            boundaryNote: 'Borders follow the present-day world.',
            historicalNote: 'Historical states and regions are approximate unions of present-day successor countries or administrative areas, not exact period borders.',
            searchPlaceholder: 'Search countries and regions…',
            searchLabel: 'Search the world map',
            clearSearch: 'Clear search',
            oneFound: 'country or region found',
            manyFound: 'countries or regions found',
            noneFound: 'No matching country or region found.',
            citizenship: 'Citizenship',
            background: 'Background',
            events: 'Events',
            citizenshipPeople: 'People by citizenship',
            backgroundPeople: 'People by national background',
            relatedEvents: 'Directly involved historical events',
            sectionNav: 'Country page sections',
        ...
        people: {
            ...
            peopleCategoriesAndSoviet: 'People categories and institution leadership timelines',
            peopleCategoriesAndSoviet2: 'People Categories and Institution Timelines',
            ...
            peopleOfChina: 'People of the Chinese revolution and the People’s Republic',
            peopleOfFrance: 'People of the French Revolution and the Napoleonic era',
            peopleBeyondTheSoviet: 'People of the wider world',
