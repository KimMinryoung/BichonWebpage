...
assert.deepEqual(eventRelationsFor(events, 'first', 'en').map(e => [e.id, e.kind]), [['overview', 'parent'], ['first', 'self'], ['second', 'sibling'], ['other', 'related']]);
...
console.log('event relations: parent, children, self-in-siblings, localization, missing/draft ids and old snapshots OK');
