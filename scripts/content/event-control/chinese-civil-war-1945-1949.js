...
module.exports = {
    ...
    base: 'kmt',
    sides: [
        { id: 'kmt', label: { ko: '국민정부', en: 'Nationalist government' } },
        { id: 'ccp', label: { ko: '공산당', en: 'Communists' } },
        { id: 'japan', label: { ko: '일본군 점령', en: 'Japanese occupation' } },
        { id: 'soviet', label: { ko: '소련군 점령', en: 'Soviet occupation' } },
        { id: 'other', label: { ko: '양측 통제 밖 (티베트 등)', en: 'Outside both (Tibet etc.)' } },
    ],
    note: {
