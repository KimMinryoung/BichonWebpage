...
- role categories: seeded in DB (`old-regime`, `writer-artist`, `theorist`, `intl-revolutionary`, `bloc-reformer`, `russian-republic-leader`, `left-opposition`, `socialist-bloc-leader`)
