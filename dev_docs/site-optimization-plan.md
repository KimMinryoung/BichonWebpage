...
> - 배치 5~9는 계획 파일 참조. 다음: 배치 5(commulingo-people.ejs·admin/commulingo-docs.ejs 인라인 JS 추출, escapeHtml 통합, nonogram IIFE, common.js defer, 죽은 CSS). 선행: root 소유 파일 chown.
>
