...
function chapter(ch, titleKo, titleEn, summaryKo, summaryEn, focusKo, focusEn, conceptKo, conceptEn, basic, advanced, extras) {
    return {
...
module.exports = {
    ...
    chapters: [
        chapter(
            ...
            ],
            {
                diagram: diagram('flow',
                    {
                        title: '자유경쟁이 독점을 낳는 길',
                        steps: [
                            { label: '자유경쟁', note: '승자가 패자를 삼키며 기업 규모가 커진다' },
                            { label: '생산의 집중', note: '소수 대기업이 노동자·동력·산출을 장악한다' },
                            { label: '협정의 유혹', note: '수십 개의 거인끼리는 담합이 쉽고 이득이 크다' },
                            { label: '독점', note: '카르텔·트러스트가 가격과 시장을 통제한다' },
                        ],
                    },
                    {
                        title: 'How free competition breeds monopoly',
                        steps: [
                            { label: 'Free competition', note: 'Winners swallow losers and firms grow huge' },
                            { label: 'Concentration of production', note: 'A few giants command workers, power, and output' },
                            { label: 'The lure of agreement', note: 'Among a few dozen giants, collusion is easy and lucrative' },
                            { label: 'Monopoly', note: 'Cartels and trusts control prices and markets' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                q(1, '은행이 단지 송금과 결제를 돕는 곳이라면 역할은 제한적이다. 레닌이 말하는 “새로운 역할”은 무엇인가?', 'If banks merely help transfers and payments, their role is limited. What is the “new role” Lenin identifies?', ['더 많은 예금을 모아 이자 차익을 키우는, 규모만 커진 중개자가 된다.', '화폐자본을 집중하고 기업의 신용과 정보를 장악해 산업을 통제하는 독점체가 된다.', '위험한 기업을 걸러 예금자를 보호하는 중립적 심판이 된다.', '산업 대출에서 손을 떼고 국채 투자에 전념하는 기관이 된다.'], ['They become merely larger middlemen, gathering more deposits to widen the interest margin.', 'They become monopolies that concentrate money capital and control industry through credit and information.', 'They become neutral referees screening out risky firms to protect depositors.', 'They withdraw from industrial lending and devote themselves to state bonds.'], '은행의 새 역할은 결제 편의가 아니라 지배력이다. 많은 자본가와 상인의 자금이 대은행에 모이면, 은행은 신용과 정보를 통해 기업 활동을 좌우한다.', 'The new role is command, not payment convenience. Once many capitalists’ and merchants’ funds gather in big banks, banks influence firms through credit and information.'),
                q(0, '대은행이 작은 은행을 없애지 않고 “계열”이나 “참여”로 묶는 방식은 무엇을 뜻하는가?', 'What does it mean when a big bank binds smaller banks through affiliation or holdings rather than simply abolishing them?', ['겉으로는 여러 기관이 남아도 실제로는 하나의 중심에 종속되는 중앙집중이다.', '작은 은행이 대은행을 민주적으로 통제한다는 뜻이다.', '은행업이 산업과 완전히 분리된다는 뜻이다.', '지방 금융이 세계시장과 무관해진다는 뜻이다.'], ['Several institutions may remain outwardly, but in reality they are centralized under one center.', 'Small banks democratically control the big bank.', 'Banking becomes completely separate from industry.', 'Local finance becomes unrelated to the world market.'], '레닌은 이런 “분산”이 실제로는 중앙집중이라고 본다. 독립된 이름과 지점이 남아도 지분, 신용, 계열 관계가 하나의 금융 중심에 대한 종속을 만든다.', 'Lenin treats this “decentralization” as real centralization. Independent names and branches may remain, but holdings, credit, and affiliation create dependence on one financial center.', ['간판과 이름은 여럿이어도 지분·신용·계열이 하나의 중심을 만든다는 것, 그것이 레닌이 말하는 실질적 중앙집중이다.', '지분과 신용을 쥔 쪽은 대은행이다. 계열로 묶인 작은 은행은 의결권 구조상 중심을 통제할 수단이 없고, 오히려 중심의 결정을 따르게 된다.', '계열화는 은행을 산업에서 떼어 놓는 것이 아니라 산업 기업까지 같은 망으로 끌어들인다. 다음 장의 금융자본이 바로 그 융합이다.', '지방 은행이 대은행 계열로 들어가는 순간 지방의 예금은 전국적, 나아가 국제적 자본 흐름의 일부가 된다. 무관해지는 것이 아니라 편입되는 것이다.'], ['Many signboards and names may remain, but holdings, credit, and affiliation build a single center; that is the real centralization Lenin describes.', 'The holdings and the credit are in the big bank’s hands. An affiliated small bank has no voting-structure means to control the center; it follows the center’s decisions instead.', 'Affiliation does not detach banks from industry; it draws industrial firms into the same network. The finance capital of the next chapter is precisely that fusion.', 'The moment a local bank enters a big bank’s orbit, local deposits become part of national and even international capital flows. It is incorporated, not disconnected.']),
                q(2, '대은행이 기업의 당좌계정과 거래 기록을 들여다볼 수 있다는 점은 왜 중요한가?', 'Why is it important that a big bank can see firms’ current accounts and transaction records?', ['기업의 상품 품질을 직접 검사할 수 있기 때문이다.', '기업의 신용도를 시장에 알려 투자자들의 판단을 돕는 공익적 정보가 되기 때문이다.', '기업의 재정상태를 파악하고 신용을 조절해 그 행동에 영향력을 행사할 수 있기 때문이다.', '예금 유치 경쟁에서 앞서기 위한 영업 자료로 쓸 수 있기 때문이다.'], ['Because it can directly inspect commodity quality.', 'Because it becomes public-interest information on creditworthiness that helps investors judge firms.', 'Because it can know firms’ financial condition and influence them by adjusting credit.', 'Because it supplies sales material for winning the competition over deposits.'], '은행의 정보력은 단순한 회계 지식이 아니다. 누가 자금난에 빠졌고 누가 확장할 수 있는지 알면, 은행은 신용을 통해 기업의 생사를 결정할 수 있다.', 'The bank’s information is not mere bookkeeping. Knowing who is short of funds and who can expand lets the bank decide firms’ fate through credit.'),
            ...
            ],
            {
                diagram: diagram('flow',
                    {
                        title: '중개자에서 지휘부로, 은행의 변신',
                        steps: [
                            { label: '지급 중개', note: '송금과 결제를 매개하는 조용한 창구' },
                            { label: '예금·정보의 집중', note: '계좌와 지점망으로 전국의 자금 흐름이 한눈에 모인다' },
                            { label: '신용의 배분', note: '누구에게 돈을 주고 누구를 끊을지 은행이 고른다' },
                            { label: '산업의 지휘부', note: '기업의 생사를 쥔 금융 독점체가 된다' },
                        ],
                    },
                    {
                        title: 'From middleman to command center: the bank transformed',
                        steps: [
                            { label: 'Payment mediation', note: 'A quiet counter mediating transfers and settlements' },
                            { label: 'Deposits and information concentrate', note: 'Accounts and branches gather national money flows into one view' },
                            { label: 'Allocation of credit', note: 'The bank chooses who receives funds and who is cut off' },
                            { label: 'Command center of industry', note: 'A financial monopoly holding the fate of firms' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                q(0, '은행과 산업 독점이 서로 얽힌 상황에서, 레닌이 금융자본으로 파악하는 관계는 무엇인가?', 'When Lenin speaks of finance capital, he does not simply mean “capital with lots of money.” What is central?', ['대은행 자본과 독점적 산업자본이 지분·신용·인적 결합을 통해 융합한다는 점', '화폐가 상품 없이도 가치의 유일한 원천이 된다는 점', '은행업이 산업을 제치고 가장 큰 이윤을 내는 업종이 된다는 점', '산업자본이 은행에 흡수되어 독립된 부문으로서는 사라진다는 점'], ['Big-bank capital and monopoly industrial capital fuse through holdings, credit, and personal links', 'Money becomes the sole source of value without commodities', 'Banking overtakes industry as the most profitable branch', 'Industrial capital is absorbed by the banks and vanishes as an independent branch'], '금융자본은 은행에 돈이 많다는 사실이 아니라 은행과 산업 독점이 서로 얽혀 지배력을 행사하는 관계다. 이 결합이 금융과두제의 토대가 된다.', 'Finance capital is not the fact that banks hold much money; it is the relation in which banks and industrial monopoly interlock and exercise command. This union is the basis of financial oligarchy.'),
            ...
            [
                q(1, '참여제도는 왜 “민주적 주식소유”처럼 보이면서도 금융과두제를 강화할 수 있는가?', 'Why can the holding system strengthen financial oligarchy while appearing as “democratic share ownership”?', ['주식 분산이 경영권 분산으로 곧장 이어진다고 보기 때문이다.', '소액 지분과 계열 지배를 통해 다수 주주의 분산된 소유 위에서 소수의 집중된 통제가 가능하기 때문이다.', '모든 주주는 회사 정보를 같은 수준으로 이용할 수 있기 때문이다.', '주식회사는 은행 신용 없이만 운영되기 때문이다.'], ['Because dispersed shareholding is assumed to lead directly to dispersed control of management.', 'Because small holdings and affiliate control make concentrated command possible over dispersed ownership.', 'Because all shareholders can use company information equally.', 'Because joint-stock companies operate only without bank credit.'], '레닌은 법적 소유 형태와 실제 통제를 구분한다. 주식이 널리 퍼져도 지분망과 은행 연결을 쥔 소수가 경영과 자금 흐름을 장악할 수 있다.', 'Lenin distinguishes legal ownership from real control. Even if shares are dispersed, those who hold the holding network and banking links can command management and capital flows.', ['주식이 흩어질수록 소액주주는 조직되지 못하고, 조직된 소수의 지분이 상대적으로 커진다. 분산된 소유는 집중된 통제의 조건이 되기도 한다.', '소유의 외형은 분산되고 통제의 실질은 집중된다는 것, 이 어긋남이 참여제도의 요점이다.', '정보는 평등하지 않다. 이사회와 은행 연결을 쥔 쪽은 회사의 재정과 계획을 먼저 알고, 소액주주는 공표된 결과만 뒤늦게 받아 본다.', '주식회사야말로 은행 신용과 증권 발행에 깊이 의존한다. 발행과 대출을 은행이 맡기 때문에 참여제도는 금융과두제의 도구가 된다.'], ['The more shares are dispersed, the less small shareholders can organize, and the relatively larger an organized minority’s stake becomes. Dispersed ownership can be a condition of concentrated control.', 'Ownership looks dispersed while control is in fact concentrated; that mismatch is the point of the holding system.', 'Information is not equal. Those holding board seats and bank links learn the firm’s finances and plans first, while small shareholders receive only published results, and late.', 'Joint-stock companies depend deeply on bank credit and share issues. Because banks handle issuing and lending, the holding system becomes a tool of the financial oligarchy.']),
                ...
                q(0, '금융자본 장에서 “생산적 투자”와 “투기적 투자”를 깨끗이 나누려는 개량주의적 관점의 약점은 무엇인가?', 'In this chapter, what is weak about the reformist attempt to cleanly separate “productive” from “speculative” investment?', ['독점 단계에서는 은행, 산업, 증권, 지분참여가 얽혀 있어 그 둘을 제도적으로 분리해 자본주의를 정화할 수 없다는 점을 놓친다.', '투기적 투자는 실제로 존재하지 않는다는 점을 과장한다.', '생산적 투자는 증권시장과 별도의 건전한 영역으로 분리될 수 있다고 본다.', '은행이 산업에 관여하지 않는다는 사실을 너무 강조한다.'], ['It misses that in the monopoly stage banks, industry, securities, and holdings are interwoven, so capitalism cannot be purified by institutionally separating the two.', 'It exaggerates that speculative investment does not really exist.', 'It assumes productive investment can be separated off as a sound sphere apart from the securities market.', 'It overemphasizes the fact that banks do not intervene in industry.'], '레닌은 투기와 생산을 도덕적으로 분리하면 금융자본의 구조를 놓친다고 본다. 독점 단계에서는 산업 지배 자체가 증권, 은행, 지분참여와 결합해 있다.', 'Lenin argues that morally separating speculation from production misses the structure of finance capital. In the monopoly stage, industrial command itself is joined to securities, banks, and holdings.'),
                q(3, '금융과두제가 “사회 전체에 조공을 부과한다”는 표현을 가장 잘 설명한 것은 무엇인가?', 'Which statement best explains the idea that the financial oligarchy “levies tribute on society”?', ['국가가 세금으로 걷은 돈을 금융가에게 보조금으로 옮겨 준다는 뜻이다.', '금융 이윤을 은행 내부 비용 절감의 결과로만 설명한다는 뜻이다.', '봉건시대처럼 무력으로 공물을 직접 걷어 간다는 뜻이다.', '주식발행, 신용조건, 국가대출, 독점가격을 통해 광범한 사회적 소득이 소수 금융집단으로 이전된다는 뜻이다.'], ['It means the state collects taxes and hands them to financiers as subsidies.', 'It explains financial profit merely as the result of cost savings inside the banks.', 'It means tribute is collected directly by force, as in feudal times.', 'Broad social income is transferred to a few financial groups through share issues, credit terms, state loans, and monopoly prices.'], '조공이라는 말은 봉건적 비유가 아니라 지배관계의 표현이다. 금융과두제는 직접 생산하지 않는 영역에서도 사회적 부를 자신에게 흘러오게 하는 장치를 가진다.', '“Tribute” is not a feudal nostalgia but an expression of domination. The financial oligarchy has mechanisms that make social wealth flow to it even outside direct production.'),
                ...
                diagram: diagram('flow',
                    {
                        title: '참여제도의 지배 사슬',
                        steps: [
                            { label: '자기자본', note: '과두제가 직접 소유한 비교적 적은 밑천' },
                            { label: '모회사 지배', note: '과반에 못 미치는 지분으로도 통제가 가능하다' },
                            { label: '자회사·손회사', note: '층을 내려갈수록 지배하는 타인 자본이 몇 배로 는다' },
                            { label: '거대 자본의 지휘', note: '적은 소유로 사회 전체의 자본 흐름을 좌우한다' },
                        ],
                    },
                    {
                        title: 'The chain of command in the holding system',
                        steps: [
                            { label: 'Own capital', note: 'A relatively small stake owned outright by the oligarchy' },
                            { label: 'Parent-company control', note: 'Even a minority holding can secure control' },
                            { label: 'Subsidiaries and sub-subsidiaries', note: 'Each layer down, the controlled outside capital multiplies' },
                            { label: 'Command of vast capital', note: 'Small ownership steers the capital flows of a whole society' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                q(0, '레닌은 자유경쟁 단계와 독점 단계의 국제경제를 구분하며 무엇이 특히 중요해졌다고 보는가?', 'Distinguishing free competition from the monopoly stage, what does Lenin say has become especially important?', ['상품수출과 구별되는 자본수출', '관세를 낮춘 자유무역의 확대', '세계 무역량의 단순한 증가', '더 싼 상품을 앞세운 판매 경쟁'], ['Export of capital as distinct from export of goods', 'The expansion of free trade with lowered tariffs', 'A simple increase in the volume of world trade', 'Sales rivalry led by cheaper goods'], '자본주의 초기에도 상품은 해외로 팔렸다. 레닌이 강조하는 새 특징은 독점과 금융자본 아래에서 자본 자체가 높은 이윤을 찾아 해외로 투자된다는 점이다.', 'Goods were sold abroad earlier too. Lenin’s new feature is that under monopoly and finance capital, capital itself is invested abroad in search of higher profit.'),
                q(2, '레닌이 말하는 “과잉자본”은 왜 국내 대중의 생활 향상으로 자동 사용되지 않는가?', 'Why is Lenin’s “surplus capital” not automatically used to improve the living standards of the masses at home?', ['자본가들이 국내 소비재 생산법을 잊었기 때문이다.', '국내 소비 확대가 수익성 문제를 시장 균형으로 자연스럽게 해결한다고 보기 때문이다.', '자본은 사회적 필요가 아니라 더 높은 이윤율을 따라 움직이기 때문이다.', '국내에는 어떤 투자 대상도 존재하지 않기 때문이다.'], ['Because capitalists forget how to produce consumer goods at home.', 'Because expanded domestic consumption naturally solves profitability through market equilibrium.', 'Because capital moves according to higher profit rates, not social need.', 'Because there are no possible investments at home at all.'], '레닌은 “과잉”을 사회 전체의 필요가 충족된 상태로 보지 않는다. 대중이 가난해도 자본가에게 충분히 높은 이윤을 주지 않는다면 자본은 더 높은 수익을 찾아 해외로 나간다.', 'Lenin does not mean that social needs are satisfied. Even if the masses are poor, capital goes abroad if domestic conditions do not provide sufficiently high profit.', ['능력이나 지식의 문제가 아니다. 소비재를 만드는 법은 그대로지만, 대중의 구매력이 낮아 그 부문의 이윤율이 자본가에게 충분치 않은 것이 문제다.', '대중의 소비를 늘리려면 임금이 올라야 하고, 임금 상승은 이윤율을 깎는다. 자본에게 이 길은 해결책이 아니라 피하고 싶은 비용이다.', '기준은 필요가 아니라 이윤율이라는 것, 그래서 가난한 국내를 두고도 자본은 해외의 고이윤을 찾아 나간다.', '국내에 투자 대상이 없는 것이 아니라 자본이 만족할 만큼 수익성 높은 대상이 부족한 것이다. 절대적 불가능이 아니라 이윤 기준의 선택이다.'], ['It is not a matter of ability or knowledge. The techniques for making consumer goods remain; the problem is that the masses’ low purchasing power leaves that branch’s profit rate insufficient for capitalists.', 'Raising mass consumption requires raising wages, and higher wages cut the profit rate. For capital this path is not a solution but a cost to be avoided.', 'The criterion is the profit rate, not need; that is why capital leaves a poor home population behind and seeks high profit abroad.', 'It is not that no investments exist at home, but that too few are profitable enough to satisfy capital. Not absolute impossibility, but a choice made by the profit criterion.']),
                q(1, '해외 차관이 항만 건설권, 철도 계약, 군수품 주문과 묶이는 사례는 자본수출의 어떤 면을 보여주는가?', 'What aspect of export of capital is shown when foreign loans are tied to port rights, railway contracts, or arms orders?', ['차관은 순수한 자선이라서 채권국 기업과 무관하다는 점', '자본수출이 상품수출과 정치적 영향력까지 끌어들이는 묶음 거래가 된다는 점', '해외투자는 주로 수입국의 자율적 산업정책에 종속된다는 점', '채무국은 차관을 받으면 금융 종속에서 벗어난다는 점'], ['Loans are pure charity and unrelated to creditor-country firms.', 'Export of capital becomes a package deal that draws in commodity exports and political influence.', 'Foreign investment is mainly subordinated to the receiving country’s autonomous industrial policy.', 'A debtor country escapes financial dependence by receiving a loan.'], '레닌은 차관이 돈의 이동에 그치지 않는다고 본다. 채권국은 대출을 통해 자국 기업의 주문, 양허권, 외교적 이익을 함께 확보한다.', 'Lenin sees loans as more than a movement of money. The creditor country uses lending to secure orders for its firms, concessions, and diplomatic advantages.'),
            ...
            [
                ...
                q(3, '프랑스 자본수출을 “고리대 제국주의”, 곧 비싼 이자를 받는 돈놀이처럼 대부 수익에 기대는 제국주의에 가깝게 보는 맥락은 무엇인가?', 'What is the context for viewing French capital export as close to “usurer imperialism”, an imperialism that lives off lending income like a moneylender charging high interest?', ['프랑스 해외투자가 식민지 직접경영보다 국내 공업 확대에 치우쳤기 때문이다.', '프랑스 투자가 대부분 국내 농업에만 머물렀기 때문이다.', '프랑스가 식민지를 완전히 포기했기 때문이다.', '프랑스 자본수출에서 산업 직접투자보다 유럽 국가대출과 채권수익의 비중이 두드러졌기 때문이다.'], ['Because French foreign investment leaned toward expanding home industry rather than direct colonial management.', 'Because French investment stayed mostly in domestic agriculture.', 'Because France completely abandoned colonies.', 'Because European state loans and bond income stood out more than direct industrial investment in French capital export.'], '레닌은 나라별 자본수출의 형태를 구별한다. 프랑스의 경우 러시아 등 유럽에 대한 대부와 채권수익이 두드러져 고리대적 성격을 강조한다.', 'Lenin distinguishes national forms of capital export. In France’s case, lending to countries such as Russia and bond income stand out, so he stresses a usurer-like character.'),
                ...
                diagram: diagram('contrast',
                    {
                        ...
                        right: {
                            heading: '자본수출 (독점 시대의 전형)',
                            rows: [
                                '돈과 생산자본 자체를 해외에 심는다',
                                '차관과 지분이 장기 종속 관계를 만든다',
                                '이익은 이자·배당·양허권으로 계속 흐른다',
                            ],
                        },
                    },
                    {
                        title: 'Export of goods and export of capital',
                        left: {
                            heading: 'Export of goods (typical of free competition)',
                            rows: [
                                'Goods are made and sold abroad',
                                'When the sale ends, so does the relation',
                                'Gain comes from the margin on sales',
                            ],
                        },
                        right: {
                            heading: 'Export of capital (typical of monopoly)',
                            rows: [
                                'Money and productive capital are planted abroad',
                                'Loans and holdings create lasting dependence',
                                'Gain keeps flowing as interest, dividends, concessions',
                            ],
                        },
                    }),
            }
        ...
        chapter(
            ...
            [
                ...
                q(2, '전기산업에서 미국의 제너럴 일렉트릭(GE)과 독일의 아에게(AEG)라는 두 거대 전기기업이 지역을 나누고 특허·경험을 교환하는 협정을 맺는 사례는 무엇을 보여주는가?', 'What is shown when General Electric (GE) of America and AEG of Germany, the two giant electrical firms, make an agreement dividing territories and exchanging patents and experience?', ['기술 발전이 독점과 결코 결합하지 않는다는 점', '국제 협정은 항상 소비자를 위한 공공계획이라는 점', '최첨단 산업에서도 독점체들이 세계를 시장권역으로 나누고 협력과 경쟁을 동시에 한다는 점', '전기산업은 금융자본과 아무 관련이 없다는 점'], ['That technical development never combines with monopoly', 'That international agreements are always public planning for consumers', 'That even the most advanced industries divide the world into market spheres while combining cooperation and rivalry', 'That electrical industry has no relation to finance capital'], '전기산업 사례는 독점이 낡은 산업에만 국한되지 않음을 보여준다. 고도 기술 산업도 자본력과 은행 연결을 바탕으로 세계적 분할 협정을 맺는다.', 'The electrical example shows monopoly is not limited to old industries. Advanced technical sectors also use capital strength and bank connections to make world-division agreements.'),
                q(0, '국제 카르텔이 평화 협정을 맺었다고 해서 레닌이 평화주의적 결론을 내리지 않는 이유는 무엇인가?', 'Why does Lenin not draw a pacifist conclusion from peaceful agreements among international cartels?', ['협정은 현재 힘의 비율에 따른 분할일 뿐이고, 불균등 발전은 그 비율을 다시 흔들기 때문이다.', '협정이 있으면 계급대립과 국가 갈등이 제도적 조정으로 안정된다고 보기 때문이다.', '국제 카르텔은 실제로 존재하지 않았기 때문이다.', '협정은 주로 노동조합의 임금교섭 방식과 비슷하게 작동하기 때문이다.'], ['Because an agreement is only a division according to the current relation of forces, and uneven development disrupts that relation.', 'Because agreements supposedly stabilize class antagonisms and state conflicts through institutional adjustment.', 'Because international cartels did not really exist.', 'Because agreements work mainly in the manner of trade-union wage bargaining.'], '레닌에게 평화적 협정과 전쟁은 서로 무관한 반대물이 아니다. 같은 세계분할의 토대 위에서 힘의 변화에 따라 협정이 충돌로, 충돌이 새 협정으로 바뀐다.', 'For Lenin, peaceful agreement and war are not unrelated opposites. On the same basis of world division, changes in strength turn agreements into conflicts and conflicts into new agreements.', ['협정은 오늘의 힘을 사진처럼 고정한 것일 뿐이고, 불균등 발전은 내일의 힘을 바꾼다. 그 간극이 재분할 투쟁의 씨앗이다.', '협정이 갈등을 제도 안에 가둔 듯 보여도, 그 제도의 토대인 자본력 비율 자체가 계속 변한다. 안정처럼 보이는 것은 힘이 아직 바뀌지 않은 동안의 휴전이다.', '레닌은 국제 카르텔의 실재를 통계와 사례로 확인한다. 그가 부정하는 것은 카르텔의 존재가 아니라 그것이 평화를 보증한다는 해석이다.', '노조 교섭은 계급 사이의 타협이지만 카르텔 협정은 자본가들끼리 시장을 나누는 담합이다. 성격이 다른 두 협정을 겹쳐 보면 분할의 지배적 성격이 가려진다.'], ['An agreement only freezes today’s strength like a photograph, and uneven development changes tomorrow’s strength. That gap is the seed of the struggle for redivision.', 'Even if an agreement seems to cage conflict inside institutions, the ratio of capital strength underneath keeps changing. What looks like stability is a truce lasting only while the forces have not yet shifted.', 'Lenin confirms the reality of international cartels with statistics and cases. What he denies is not their existence but the reading that they guarantee peace.', 'Union bargaining is a compromise between classes; a cartel agreement is collusion among capitalists dividing a market. Overlaying the two hides the dominating character of the division.']),
                q(3, '석유시장에서 미국의 석유 트러스트인 스탠더드 오일, 러시아 석유를 쥔 로스차일드·노벨 금융가문, 독일 은행들이 얽히는 사례가 보여주는 것은 무엇인가?', 'What is shown by the oil-market example in which Standard Oil, the American oil trust, the Rothschild and Nobel financial houses controlling Russian oil, and German banks become entangled?', ['원료산업은 국제 경쟁과 무관하다는 점', '은행은 원료지 확보에 관심이 없다는 점', '국가정책은 독점체의 이해와 연결되지 않는다는 점', '원료지와 운송, 금융 연결을 둘러싼 독점체들의 세계적 재분할 투쟁'], ['That raw-material industries are unrelated to international rivalry', 'That banks have no interest in securing raw-material sources', 'That state policy is not linked to monopoly interests', 'A global struggle among monopolies over raw materials, transport, and financial links'], '석유 사례에서 독점체와 대은행, 국가정책은 분리되지 않는다. 원료와 운송을 둘러싼 경쟁은 이미 세계분할과 재분할의 문제다.', 'In the oil example, monopolies, big banks, and state policy are not separate. Rivalry over raw materials and transport is already a question of world division and redivision.'),
            ...
            ],
            {
                diagram: diagram('flow',
                    {
                        title: '국내 독점에서 재분할 압력까지',
                        steps: [
                            { label: '국내시장 장악', note: '카르텔이 먼저 자국 시장을 나눈다' },
                            { label: '해외로 확장', note: '자본수출과 지점망이 국경을 넘는다' },
                            { label: '국제 협정', note: '자본력 비율대로 시장·특허·원료를 나눈다' },
                            { label: '힘의 비율 변화', note: '불균등 발전이 어제의 비율을 낡게 만든다' },
                            { label: '재분할 압력', note: '협정이 흔들리고 분할 투쟁이 다시 시작된다' },
                        ],
                    },
                    {
                        title: 'From domestic monopoly to pressure for redivision',
                        steps: [
                            { label: 'Home market captured', note: 'Cartels first divide their own market' },
                            { label: 'Expansion abroad', note: 'Capital export and agencies cross borders' },
                            { label: 'International agreement', note: 'Markets, patents, raw materials split by capital strength' },
                            { label: 'The ratio of forces shifts', note: 'Uneven development makes yesterday’s ratio obsolete' },
                            { label: 'Pressure for redivision', note: 'Agreements shake and the struggle over shares resumes' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                ...
                q(3, '독일처럼 후발적으로 빠르게 성장한 나라가 기존 식민지 분할에 불만을 품는 이유는 무엇인가?', 'Why would a rapidly rising latecomer such as Germany become dissatisfied with the existing colonial division?', ['경제력이 약한 국가는 보상적 외교로 더 많은 식민지를 배정받기 때문이다.', '식민지는 이미 모든 나라에 균등하게 배분되어 있기 때문이다.', '후발 국가는 해외시장에 관심이 없기 때문이다.', '자본력과 산업력이 커졌지만 과거 분할에서 받은 몫은 작아 새 세력관계와 기존 분할이 충돌하기 때문이다.'], ['Because weaker states are allotted more colonies through compensatory diplomacy.', 'Because colonies have already been equally distributed to all countries.', 'Because latecomers have no interest in foreign markets.', 'Because its capital and industry have grown while its old share remains small, so the new relation of forces clashes with the old division.'], '제국주의의 폭발성은 불균등 발전에서 나온다. 힘은 변하지만 영토분할은 과거의 결과로 굳어져 있으므로, 새 강자는 재분할을 요구하게 된다.', 'Imperialism’s explosiveness comes from uneven development. Strength changes while territorial division is fixed from the past, so new powers demand redivision.', ['식민지는 약자에 대한 배려로 배정된 적이 없다. 분할의 통화는 자본력과 군사력이며, 약해진 나라는 오히려 이미 가진 몫을 지키기도 어려워진다.', '통계가 보여주는 것은 균등이 아니라 극단적 편중이다. 영국과 프랑스가 압도적 몫을 쥔 상태에서 후발국의 몫은 커진 경제력에 비해 작았다.', '후발국일수록 커진 생산력을 소화할 시장과 원료가 절실하다. 무관심이 아니라, 늦게 도착해 보니 좋은 자리가 이미 차 있었다는 것이 문제다.', '커진 힘과 굳어 버린 분할 사이의 어긋남, 바로 그 간극이 재분할 요구와 전쟁 압력의 원천이다.'], ['Colonies have never been allotted out of consideration for the weak. The currency of partition is capital and military strength, and a weakening state finds it hard even to keep the share it has.', 'What the statistics show is not equality but extreme lopsidedness. With Britain and France holding overwhelming shares, the latecomer’s share was small relative to its grown economic power.', 'The later a power rises, the more urgently it needs markets and raw materials to absorb its grown productive forces. Not indifference: it arrived late and found the good seats already taken.', 'The mismatch between grown strength and a hardened division: that gap is the source of demands for redivision and the pressure toward war.']),
                q(2, '정치적으로 독립된 중국, 페르시아(지금의 이란), 터키 같은 사례를 레닌이 반식민지로 다루는 이유는 무엇인가?', 'Why does Lenin treat cases such as China, Persia (today’s Iran), and Turkey as semi-colonial despite formal political independence?', ['그 나라들이 이미 유럽의 지방정부였기 때문이다.', '그곳에는 어떤 외국 자본도 들어오지 않았기 때문이다.', '열강의 차관, 조차(항만·영토의 강제 임차), 세력권, 군사·외교 압력이 실질적 종속을 만들기 때문이다.', '정치적 독립은 경제관계와 항상 무관하기 때문이다.'], ['Because they were already local European governments.', 'Because no foreign capital entered them.', 'Because loans, forced leases of ports and territory, spheres of influence, and military-diplomatic pressure by great powers created real dependence.', 'Because political independence is always unrelated to economic relations.'], '반식민지는 레닌의 제국주의 분석에서 중요한 중간형태다. 직접 병합이 없어도 금융자본과 열강의 압력은 국가의 선택지를 제한한다.', 'Semi-colony is an important transitional form in Lenin’s analysis. Even without direct annexation, finance capital and great-power pressure restrict a state’s choices.'),
                q(0, '이 장의 세계분할 분석이 “평화적 제국주의” 전망과 충돌하는 이유는 무엇인가?', 'Why does this chapter’s analysis of world partition conflict with hopes for “peaceful imperialism”?', ['세계가 이미 나뉘었고 불균등 발전이 계속되므로 새 힘의 비율은 기존 분할과 충돌할 수밖에 없기 때문이다.', '모든 열강이 같은 속도로 성장하므로 분쟁 원인이 사라지기 때문이다.', '식민지 문제는 금융자본과 거리가 있어 외교 협상으로 안정될 수 있기 때문이다.', '식민지 유지 비용이 커서 강대국들이 스스로 추가 팽창을 자제하게 되기 때문이다.'], ['Because the world is already divided and uneven development continues, so new relations of strength must collide with the old division.', 'Because all great powers grow at the same pace, removing causes of conflict.', 'Because colonial questions are thought to stand apart from finance capital and can be settled by diplomatic negotiation.', 'Because the cost of holding colonies leads great powers to restrain further expansion on their own.'], '레닌에게 평화적 분할은 일시적 형태일 뿐이다. 세계가 이미 나뉜 상태에서 자본주의적 힘의 불균등 변화는 재분할의 압력을 만든다.', 'For Lenin, peaceful division is only a temporary form. In a world already divided, uneven changes in capitalist strength produce pressure for redivision.'),
            ],
            {
                diagram: diagram('contrast',
                    {
                        title: '영토를 갖는 지배와 영토 없는 지배',
                        left: {
                            heading: '식민지 (직접 지배)',
                            rows: [
                                '총독과 군대가 직접 통치한다',
                        ...
                        right: {
                            heading: '반식민지·세력권 (금융 지배)',
                            rows: [
                                '정부는 남지만 차관 조건이 정책을 묶는다',
                                '철도·항만·관세 수입이 담보로 잡힌다',
                                '지도에는 없고 장부에 드러난다',
                            ],
                        },
                    },
                    {
                        title: 'Rule with territory and rule without it',
                        left: {
                            heading: 'Colony (direct rule)',
                            rows: [
                                'A governor and troops rule directly',
                                'The metropole sets tariffs and laws',
                                'Visible as colour on the map',
                            ],
                        },
                        right: {
                            heading: 'Semi-colony and sphere (financial rule)',
                            rows: [
                                'A government remains, but loan terms bind its policy',
                                'Railways, ports, customs revenue stand as collateral',
                                'Invisible on maps, visible in the ledgers',
                            ],
                        },
                    }),
            }
        ...
        chapter(
            ...
            [
                q(0, '레닌이 제국주의의 가장 짧은 정의로 제시하는 것은 무엇인가?', 'What is Lenin’s briefest definition of imperialism?', ['자본주의의 독점 단계', '모든 해외무역 일반', '강대국의 침략적 대외정책 일반', '영토 정복을 좋아하는 지도자의 성향'], ['The monopoly stage of capitalism', 'All foreign trade in general', 'The aggressive foreign policy of great powers in general', 'Leaders’ personal taste for territorial conquest'], '레닌은 제국주의를 단순히 침략적 태도나 해외정책으로 정의하지 않는다. 경제적 핵심은 자유경쟁에서 독점으로 이행한 자본주의의 특수 단계다.', 'Lenin does not define imperialism simply as an aggressive attitude or foreign policy. Its economic core is a special stage of capitalism in which free competition has turned into monopoly.'),
                ...
                q(2, '카우츠키가 제국주의를 산업자본주의가 선호할 수 있는 하나의 정책으로 좁힐 때 레닌이 비판하는 지점은 무엇인가?', 'When Kautsky narrows imperialism to one policy preferred by industrial capitalism, what does Lenin criticize?', ['정책 문제를 너무 경제적으로 본다는 점', '식민지 문제를 지나치게 계급적으로 본다는 점', '금융자본의 독점 단계라는 경제적 토대를 흐리고 제국주의를 선택 가능한 정책처럼 만든다는 점', '자본수출의 중요성을 과도하게 인정한다는 점'], ['That he treats policy too economically', 'That he treats colonial questions too class-wise', 'That he obscures the economic basis in monopoly finance capital and makes imperialism look like a selectable policy', 'That he overrecognizes the importance of export of capital'], '레닌의 반박은 제국주의가 단순한 정책 선택이 아니라 자본주의 발전 단계라는 데 있다. 정책 형태만 보면 독점과 금융자본의 필연적 압력을 놓친다.', 'Lenin’s reply is that imperialism is not a mere policy choice but a stage of capitalist development. Looking only at policy form misses the necessary pressure of monopoly and finance capital.', ['레닌의 비판은 정반대 방향이다. 카우츠키는 경제 분석이 지나친 것이 아니라, 정책이라는 정치 형태를 그 경제 토대에서 떼어 냈다는 것이 문제다.', '레닌의 불만은 계급 분석의 과잉이 아니라 부족이다. 정책론은 금융자본의 계급적 이해를 흐리고 문제를 선의의 외교로 옮겨 놓는다.', '단계와 정책의 구분이 급소다. 독점이라는 토대를 지운 채 정책만 보면 제국주의는 마음먹기에 따라 벗을 수 있는 옷이 된다.', '레닌 자신이 자본수출을 다섯 특징의 하나로 강조한다. 카우츠키의 문제는 자본수출의 과대평가가 아니라 그것을 낳는 독점 단계를 지나친 데 있다.'], ['Lenin’s criticism runs the opposite way. Kautsky’s fault is not too much economics, but detaching the political form of policy from its economic basis.', 'Lenin’s complaint is not an excess of class analysis but a lack of it. The policy view blurs finance capital’s class interests and shifts the problem onto well-meaning diplomacy.', 'The distinction between stage and policy is the crux. Erase the basis of monopoly and look only at policy, and imperialism becomes a coat that can be taken off at will.', 'Lenin himself stresses export of capital as one of the five features. Kautsky’s problem is not overrating capital export but passing over the monopoly stage that produces it.']),
            ...
            [
                ...
                q(2, '철도 통계가 제국주의 특수 단계 분석에서 맡는 역할은 무엇인가?', 'What role do railway statistics play in the analysis of imperialism as a special stage?', ['철도 확장이 주로 지역 교통 개선의 지표라고 본다.', '철도 길이를 정치제도 발전의 대략적 지표로 읽는다.', '식민지와 반식민지에서 자본주의 발전이 빠르게 확장되지만 그 지배권은 소수 금융자본 국가에 집중됨을 보여준다.', '철도망 확대가 영토분할 문제를 점차 완화한다고 본다.'], ['They treat railway expansion mainly as an index of improved local transport.', 'They read railway mileage as a rough index of political development.', 'They show capitalist development rapidly expanding in colonies and semi-colonies while command remains concentrated in a few finance-capital countries.', 'They show that expanding rail networks gradually soften the problem of territorial division.'], '레닌은 철도를 세계 자본주의의 물질적 지표로 본다. 철도 확장은 발전이지만, 누가 투자하고 통제하는가를 보면 금융자본의 지배와 불균등성이 드러난다.', 'Lenin treats railways as a material indicator of world capitalism. Railway expansion is development, but who invests and controls reveals finance capital’s rule and unevenness.'),
            ...
            ],
            {
                diagram: diagram('flow',
                    {
                        title: '다섯 특징은 하나의 사슬이다',
                        steps: [
                            { label: '집중과 독점', note: '생산과 자본의 집중이 독점체를 낳는다' },
                            { label: '금융자본', note: '은행과 산업 독점이 융합해 과두제를 이룬다' },
                            { label: '자본수출', note: '집중된 자본이 고이윤을 찾아 국경을 넘는다' },
                            { label: '경제적 세계분할', note: '국제 독점체가 시장과 원료를 나눈다' },
                            { label: '영토적 세계분할', note: '열강이 식민지와 세력권의 분할을 완성한다' },
                        ],
                    },
                    {
                        title: 'The five features form one chain',
                        steps: [
                            { label: 'Concentration and monopoly', note: 'Concentration of production and capital breeds monopolies' },
                            { label: 'Finance capital', note: 'Bank and industrial monopoly fuse into an oligarchy' },
                            { label: 'Export of capital', note: 'Concentrated capital crosses borders for higher profit' },
                            { label: 'Economic world division', note: 'International monopolies divide markets and raw materials' },
                            { label: 'Territorial world division', note: 'Great powers complete the partition of colonies and spheres' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                q(2, '레닌이 독점에서 “기생성과 부패”를 말할 때, 곧바로 모든 성장이 멈춘다는 뜻인가?', 'When Lenin speaks of “parasitism and decay” under monopoly, does he mean all growth immediately stops?', ['그렇다. 독점의 우세는 생산과 기술의 활력을 크게 약화시킨다.', '그렇다. 부패는 주로 총생산 감소로만 확인된다.', '아니다. 급속한 성장도 가능하지만 독점이 정체, 금융수입, 매수, 불균등성을 함께 키운다는 뜻이다.', '아니다. 그래서 독점은 아무 모순도 없는 진보만 뜻한다.'], ['Yes. Once monopoly appears, production and technique immediately stop.', 'Yes. Decay means only a decline in total output.', 'No. Rapid growth is possible, but monopoly also expands stagnation, rentier income, bribery, and unevenness.', 'No. Therefore monopoly means pure progress without contradictions.'], '레닌의 “부패”는 단순한 정지론이 아니다. 독점자본주의는 기술과 생산을 발전시키면서도, 그 발전을 기생적 금융수입과 정체 경향, 계급 매수와 결합시킨다.', 'Lenin’s “decay” is not a simple theory of standstill. Monopoly capitalism can develop technique and production while tying that development to parasitic financial income, stagnation tendencies, and class bribery.', ['독점 단계에도 생산과 기술은 빠르게 성장할 수 있다. 레닌 자신이 독일과 미국의 급성장을 지적하며, 부패를 성장 정지와 동일시하지 말라고 경고한다.', '총생산 통계만 보면 기생성은 보이지 않는다. 부패는 산출 감소가 아니라 금리생활자층의 팽창, 혁신 지연, 노동귀족 매수 같은 구조적 징후로 나타난다.', '성장과 부패가 함께 간다는 것, 이 모순적 결합이 레닌의 기생성 개념의 요점이다.', '모순이 없다는 결론은 반대편 극단이다. 성장이 계속되더라도 그 성장은 정체 경향, 기생적 수입, 계급 매수와 얽혀 있다는 것이 이 장의 분석이다.'], ['Production and technique can still grow rapidly in the monopoly stage. Lenin himself points to the rapid rise of Germany and the United States and warns against equating decay with a halt in growth.', 'Total output statistics alone will never show parasitism. Decay appears not as falling output but in structural signs: a swelling rentier stratum, delayed innovation, the bribing of a labour aristocracy.', 'Growth and decay go together; that contradictory combination is the point of Lenin’s concept of parasitism.', 'Concluding that there is no contradiction is the opposite extreme. Even as growth continues, it is entangled with stagnation tendencies, parasitic income, and class bribery; that is this chapter’s analysis.']),
                q(0, '독점가격이 기술혁신을 늦출 수 있다는 레닌의 논리는 무엇인가?', 'What is Lenin’s logic for saying monopoly prices can slow technical innovation?', ['독점체는 높은 가격과 지배적 지위를 통해 비용절감 압력을 덜 받을 수 있고, 때로는 불리한 발명을 묻어둘 수 있다.', '독점체는 규모가 커질수록 연구개발에 쓸 자금이 오히려 부족해지기 때문이다.', '기술혁신은 독점보다 분산된 생산자 사이에서 더 안정적으로 일어난다고 보기 때문이다.', '독점가격이 특허의 법정 보호 기간을 단축시키기 때문이다.'], ['A monopoly can face less pressure to cut costs because of high prices and dominant position, and can sometimes suppress inconvenient inventions.', 'Because the larger a monopoly grows, the shorter its funds for research and development run.', 'Because technical innovation is thought to occur more steadily among dispersed producers than under monopoly.', 'Because monopoly prices shorten the legal term of patent protection.'], '독점은 기술을 조직하기도 하지만, 경쟁 압력이 약해진 지점에서는 혁신을 지연하거나 통제할 수 있다. 그래서 발전과 정체가 함께 나타난다.', 'Monopoly can organize technique, but where competitive pressure weakens it can delay or control innovation. Development and stagnation therefore coexist.'),
                q(0, '“금리생활자 국가” 또는 채권국의 성격은 무엇과 연결되는가?', 'What is the character of a “rentier state” or creditor country connected with?', ['국내 생산과 무관하게 해외투자 수익과 이자, 배당으로 살아가는 층이 커지는 현상', '제조업 수출로 무역흑자를 쌓는 산업 강국이 되는 현상', '해외 차관이 채권국의 산업 이해와 느슨하게만 연결되는 현상', '산업자본이 완전히 사라져 상품이 생산되지 않는 현상'], ['The growth of strata living from foreign-investment income, interest, and dividends apart from production', 'Becoming an industrial power piling up trade surpluses through manufactured exports', 'Foreign loans being only loosely connected with the creditor country’s industrial interests', 'Industrial capital disappearing completely so no commodities are produced'], '자본수출이 커지면 채권국에는 생산에서 떨어진 금융수입층이 커진다. 레닌은 이를 제국주의의 기생성을 보여주는 중요한 징후로 본다.', 'As capital export grows, creditor countries develop strata living from financial income apart from production. Lenin sees this as an important sign of imperialism’s parasitism.'),
                ...
                diagram: diagram('flow',
                    {
                        title: '초과이윤이 흘러가는 길',
                        steps: [
                            { label: '독점 초과이윤', note: '식민지와 세계시장 지배가 웃돈을 만든다' },
                            { label: '금리생활자층 팽창', note: '생산 밖에서 이자·배당으로 사는 층이 붇는다' },
                            { label: '노동귀족 매수', note: '웃돈 일부가 노동자 상층의 지위를 떠받친다' },
                            { label: '기회주의', note: '노동운동 안에 제국주의 옹호 노선이 자란다' },
                        ],
                    },
                    {
                        title: 'Where the superprofits flow',
                        steps: [
                            { label: 'Monopoly superprofits', note: 'Colonial and world-market rule yields a premium' },
                            { label: 'A swelling rentier stratum', note: 'Layers living on interest and dividends grow outside production' },
                            { label: 'Bribing a labour aristocracy', note: 'Part of the premium props up the position of upper worker layers' },
                            { label: 'Opportunism', note: 'A pro-imperialist line grows inside the workers’ movement' },
                        ],
                    }),
            }
        ),
        chapter(
            ...
            [
                q(1, '어떤 비판자가 식민지 폭력과 부패를 비난하면서도 독점과 금융자본은 건드리지 않는다. 레닌이 문제 삼는 지점은 무엇인가?', 'What is Lenin’s main problem with bourgeois critiques of imperialism?', ['제국주의를 너무 계급적으로 비판한다는 점', '독점과 금융자본의 토대는 그대로 둔 채 부패, 과잉, 폭력만 줄이려 한다는 점', '해외투자의 존재를 부차적인 외교 문제로만 다룬다는 점', '평화 호소를 모두 혁명적 노선으로 만든다는 점'], ['That they criticize imperialism too class-consciously', 'That they leave the basis of monopoly and finance capital intact while trying to reduce corruption, excess, or violence', 'That they treat foreign investment as a merely secondary diplomatic question', 'That they make all appeals for peace revolutionary'], '레닌은 제국주의의 나쁜 결과만 비판하고 경제적 토대를 보존하는 입장을 비판한다. 독점과 금융자본을 건드리지 않으면 같은 압력이 반복된다.', 'Lenin criticizes views that attack only imperialism’s bad results while preserving its economic basis. If monopoly and finance capital are untouched, the same pressures recur.'),
                q(0, '자유경쟁으로 돌아가자는 소부르주아적 비판에 대해 레닌이 제기하는 반론은 무엇인가?', 'What objection does Lenin raise against the petty-bourgeois call to return to free competition?', ['독점은 자유경쟁이 낳은 산물이므로, 그 토대를 보존한 채 과거의 “평화로운 경쟁”으로 돌아갈 수 없다는 점', '자유경쟁은 역사상 존재한 적이 없다는 점', '독점은 봉건제가 만든 것이므로 자본주의와 무관하다는 점', '자유경쟁 회복이 노동운동의 조건을 충분히 개선한다고 보는 점'], ['Monopoly is the product of free competition, so one cannot preserve the basis and return to past “peaceful competition.”', 'Free competition never existed in history.', 'Monopoly was created by feudalism and has no relation to capitalism.', 'That restoring free competition would sufficiently improve the conditions of the workers’ movement.'], '레닌에게 독점은 자유경쟁의 외부 적이 아니라 그 결과다. 따라서 독점의 폐해만 싫어하며 자유경쟁 자본주의로 회귀하자는 주장은 역사적 운동을 거꾸로 돌리려는 환상이다.', 'For Lenin, monopoly is not an external enemy of free competition but its result. Wanting only to remove monopoly’s harms and return to free-competition capitalism is an illusion of reversing historical development.', ['독점이 자유경쟁의 자식이라는 점이 급소다. 어머니를 되살리면 같은 자식이 다시 태어난다.', '레닌은 자유경쟁 단계의 실재를 부정하지 않는다. 그의 논점은 그 단계가 실재했고, 바로 그 경쟁이 집중과 독점을 낳으며 스스로를 폐기했다는 것이다.', '독점은 봉건 잔재가 아니라 자본주의 자체의 산물이다. 봉건제 탓으로 돌리면 자본주의를 그대로 둔 채 독점만 도려낼 수 있다는 환상이 생긴다.', '이 선택지는 반론의 기준을 잘못 잡았다. 레닌의 반론은 복귀가 바람직한가가 아니라 역사적으로 불가능하다는 데 있다. 독점을 낳은 토대를 두고 과거로 돌아갈 수는 없다.'], ['That monopoly is the child of free competition is the vital point: revive the mother and the same child is born again.', 'Lenin does not deny that the free-competition stage was real. His point is that it was real, and that this very competition produced concentration and monopoly, abolishing itself.', 'Monopoly is not a feudal remnant but a product of capitalism itself. Blaming feudalism breeds the illusion that monopoly can be cut out while capitalism is left standing.', 'This choice mistakes the criterion of the objection. Lenin’s objection is not whether the return is desirable but that it is historically impossible: one cannot go back while keeping the basis that produced monopoly.']),
                q(3, '국제 카르텔과 국가 간 협정이 있으니 장기 평화가 가능하다는 주장에 대해, 레닌은 어디를 찌르는가?', 'What is central in Lenin’s critique of Kautsky’s “ultra-imperialism”?', ['국제적 평화 협정은 실제로 한 번도 없었다는 주장', '제국주의 국가는 협정을 맺을 능력이 없다는 주장', '평화 가능성을 제시하는 것만으로 노동자 정치가 충분히 급진화된다는 주장', '자본주의가 유지되는 한 국제 동맹은 일시적 휴전일 뿐, 불균등 발전과 세력 변화가 새 충돌을 낳는다는 주장'], ['The claim that international peaceful agreements have never existed', 'The claim that imperialist states cannot make agreements', 'The claim that merely holding out the possibility of peace sufficiently radicalizes workers’ politics', 'The claim that as long as capitalism remains, international alliances are temporary truces and uneven development produces new conflicts'], '레닌은 협정의 가능성을 부정하지 않는다. 문제는 협정을 영구평화의 씨앗처럼 제시해 현재의 모순과 기회주의를 가리는 데 있다.', 'Lenin does not deny that agreements are possible. The problem is presenting them as seeds of permanent peace, thereby obscuring current contradictions and opportunism.'),
            ...
            [
                ...
                q(0, '“평화적 동맹은 전쟁을 준비하고, 전쟁은 새 평화적 동맹을 낳는다”는 레닌의 논리는 무엇을 겨냥하는가?', 'What does Lenin target with the logic that peaceful alliances prepare wars and wars produce new peaceful alliances?', ['평화와 전쟁을 서로 다른 체제의 산물처럼 분리해 노동자를 안심시키는 초제국주의 환상', '외교 협정이 사회주의적 조정으로 발전할 수 있다는 주장', '전쟁의 원인을 주로 외교적 오판에서 찾는 주장', '노동운동이 국제문제를 다루면 안 된다는 주장'], ['The ultra-imperialist illusion that separates peace and war as products of different systems and reassures workers', 'The claim that diplomatic agreements can develop into socialist coordination', 'The claim that the causes of war lie mainly in diplomatic miscalculation', 'The claim that workers’ movements must not address international questions'], '레닌은 평화 협정과 전쟁을 한 사슬의 서로 다른 고리로 본다. 둘 다 금융자본과 세계분할의 같은 토대 위에서 나타난다.', 'Lenin treats peaceful agreements and wars as different links in one chain. Both arise on the same basis of finance capital and world division.'),
                q(2, '제국주의 비판에서 “정직한 경쟁”에 대한 향수가 위험한 이유는 무엇인가?', 'Why is nostalgia for “honest competition” dangerous in the critique of imperialism?', ['정직한 경쟁은 독점보다 더 높은 단계의 사회주의이기 때문이다.', '상업 관행을 더 투명하게 만들면 금융자본의 지배도 점차 약해진다고 보기 때문이다.', '독점이 자유경쟁 자체에서 발생했다는 역사적 사실을 가리고, 자본주의의 낡은 형태로 퇴행하는 환상을 주기 때문이다.', '노동자에게 국제주의보다 소비자 윤리가 더 중요하다는 뜻이기 때문이다.'], ['Because honest competition is a higher stage of socialism than monopoly.', 'Because making commercial practice more transparent is thought gradually to weaken the rule of finance capital.', 'Because it hides the historical fact that monopoly arose from free competition itself and creates the illusion of regressing to an older capitalism.', 'Because consumer ethics are more important for workers than internationalism.'], '레닌은 독점의 폐해를 자유경쟁의 미화로 해결할 수 없다고 본다. 자유경쟁은 바로 독점을 낳은 역사적 토대였다.', 'Lenin argues that monopoly’s harms cannot be solved by idealizing free competition. Free competition was precisely the historical basis that produced monopoly.'),
                ...
                diagram: diagram('contrast',
                    {
                        title: '두 가지 제국주의 비판',
                        left: {
                            heading: '표면 비판 (부르주아·카우츠키식)',
                            rows: [
                                '폭력과 부패라는 과잉을 비난한다',
                                '제국주의를 선택 가능한 정책으로 본다',
                                '해법은 규제 강화나 자유경쟁 복귀다',
                                '독점·금융자본의 토대는 그대로 남는다',
                            ],
                        },
                        right: {
                            heading: '마르크스주의 비판',
                            rows: [
                                '과잉을 낳는 경제구조를 겨냥한다',
                                '제국주의를 독점 단계의 필연으로 본다',
                                '해법은 토대 자체에 맞선 계급투쟁이다',
                                '노동운동 안의 기회주의까지 문제 삼는다',
                            ],
                        },
                    },
                    {
                        title: 'Two critiques of imperialism',
                        left: {
                            heading: 'Surface critique (bourgeois, Kautskyan)',
                            rows: [
                                'Denounces the excesses of violence and corruption',
                                'Treats imperialism as a selectable policy',
                                'Remedy: regulation or a return to free competition',
                                'The basis of monopoly and finance capital stays intact',
                            ],
                        },
                        right: {
                            heading: 'Marxist critique',
                            rows: [
                                'Targets the economic structure behind the excesses',
                                'Treats imperialism as the necessity of the monopoly stage',
                                'Remedy: class struggle against the basis itself',
                                'Also confronts opportunism inside the workers’ movement',
                            ],
                        },
                    }),
            }
        ...
        chapter(
            ...
            [
                ...
                q(2, '레닌이 말하는 독점의 주요 형태로 가장 적절한 묶음은 무엇인가?', 'Which set best matches the main forms of monopoly Lenin discusses?', ['농촌 공동체, 길드, 왕실 특권, 교회 토지', '보호관세, 수출보조금, 저가 덤핑, 통상조약', '카르텔·트러스트, 원료지 장악, 은행 독점, 식민지 분할', '증권 투기, 환투기, 부동산 지대, 고리대금'], ['Peasant communes, guilds, royal privilege, church land', 'Protective tariffs, export subsidies, dumping, trade treaties', 'Cartels and trusts, control of raw materials, bank monopoly, colonial partition', 'Stock speculation, currency speculation, ground rents, usury'], '레닌은 독점이 산업 내부의 카르텔만이 아니라 원료, 은행, 식민정책 속에서도 나타난다고 정리한다. 이것들이 제국주의의 역사적 위치를 규정한다.', 'Lenin summarizes monopoly not only as cartels inside industry but also in raw materials, banks, and colonial policy. These define imperialism’s historical place.'),
                q(1, '제국주의가 “이행기의 자본주의”라는 말은 무엇을 뜻하는가?', 'What does it mean that imperialism is “capitalism in transition”?', ['자본주의가 국제 협정을 통해 평화로운 조정 단계에 들어섰다는 뜻', '사회화된 생산이 사적 소유와 충돌하며 자본주의를 넘어설 물질적 조건을 성숙시킨다는 뜻', '자본주의가 다시 수공업으로 돌아간다는 뜻', '계급투쟁 없이 금융가가 자발적으로 권력을 포기한다는 뜻'], ['Capitalism has entered a stage of peaceful adjustment through international agreements.', 'Socialized production collides with private ownership and matures material conditions for going beyond capitalism.', 'Capitalism returns to handicraft.', 'Financiers voluntarily give up power without class struggle.'], '이행기는 자동 붕괴나 평화적 조화가 아니다. 독점은 생산을 거대한 사회적 과정으로 조직하지만, 그 조직은 사적 소유와 이윤의 껍질 안에서 더 이상 맞지 않게 된다.', 'Transition does not mean automatic collapse or peaceful harmony. Monopoly organizes production as a vast social process, but this organization no longer fits the shell of private ownership and profit.', ['평화로운 조정이라는 그림은 카우츠키의 초제국주의 전망에 가깝다. 레닌의 이행기는 조화가 아니라 사회화된 생산과 사적 껍질의 충돌이 깊어지는 시기다.', '독점이 스스로 키운 사회화된 생산이 사적 소유라는 껍질과 맞지 않게 된다는 것, 이 모순의 성숙이 이행기의 내용이다.', '레닌의 방향은 뒤가 아니라 앞이다. 독점은 수공업으로 돌아가는 길이 아니라, 이미 사회적으로 조직된 생산을 누가 통제할 것인가라는 문제를 제기한다.', '이행은 자동으로도, 자발적으로도 오지 않는다. 조건은 경제가 성숙시키지만 해결은 계급투쟁의 문제로 남는다는 것이 레닌의 결론이다.'], ['The picture of peaceful adjustment is close to Kautsky’s prospect of ultra-imperialism. Lenin’s transition is not harmony but a period in which the clash between socialized production and the private shell deepens.', 'Socialized production, which monopoly itself has raised, no longer fits the shell of private ownership; the maturing of this contradiction is the content of transition.', 'Lenin’s direction is forward, not back. Monopoly is not a road returning to handicraft; it poses the question of who is to control production that is already socially organized.', 'Transition comes neither automatically nor voluntarily. The economy matures the conditions, but their resolution remains a matter of class struggle; that is Lenin’s conclusion.']),
                ...
                diagram: diagram('contrast',
                    {
                        ...
                        left: {
                            heading: '내용: 사회화된 생산',
                            rows: [
                                '원료부터 판매까지 사회적으로 계획된다',
                                '수백만 명의 노동이 하나로 얽힌다',
                                '기술과 조직은 이미 공동 운영을 예비한다',
                            ],
                        },
                        right: {
                            heading: '껍질: 사적 전유',
                    ...
                    {
                        title: 'Content and shell',
                        left: {
                            heading: 'Content: socialized production',
                            rows: [
                                'Planned socially from raw material to sale',
                                'The labour of millions is interwoven into one process',
                                'Technique and organization already prefigure common management',
                            ],
                        },
                        right: {
                            heading: 'Shell: private appropriation',
                            rows: [
                                'Control rests in the hands of a few owners',
                                'The results are appropriated as monopoly profit',
                                'The old shell clashes ever more sharply with the content',
                            ],
                        },
                    }),
            }
