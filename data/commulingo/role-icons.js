const roleIconPaths = {
    ...
    'git-branch': '<path d="M6 3v12"/><path d="M6 15c0 3.3 2.7 6 6 6h6"/><path d="M6 9c0-3.3 2.7-6 6-6h6"/><circle cx="18" cy="3" r="2"/><circle cx="18" cy="21" r="2"/><circle cx="6" cy="15" r="2"/>',
